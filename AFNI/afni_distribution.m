...
for subject = 1:198
    ...
    data = load_nii(['/home/andek/Research_projects/SingleSubject/Results/Beijing/6mm/boxcar10_REML/' subjectString '.results/activity_map.nii.gz']);
    data = data.img;
    data = double(data);
...
save('afni_allvalues.mat','all_values');
