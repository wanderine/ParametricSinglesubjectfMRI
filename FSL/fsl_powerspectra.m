...
for subject = 1:198
    ...
    data = load_nii(['/home/andek/Research_projects/RandomGroupAnalyses/Results/Beijing/6mm/boxcar10/' subjectString '.feat/stats/res4d.nii.gz']);
    data = data.img;
    data = double(data);
    
    mask = load_nii(['/home/andek/Research_projects/RandomGroupAnalyses/Results/Beijing/6mm/boxcar10/' subjectString '.feat/mask.nii.gz']);
    mask = mask.img;
    mask = double(mask);
...
%save('fsl_powerspectra.mat','MEAN_TIMESERIES');
